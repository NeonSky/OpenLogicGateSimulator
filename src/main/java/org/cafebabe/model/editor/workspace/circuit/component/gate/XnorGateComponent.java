...
/** A component that outputs the logical XNOR operation of its two inputs. */
public class XnorGateComponent extends Component {
    ...
    public XnorGateComponent() {
        super("GATE_Xnor", "XNOR Gate", "Emits no signal if exactly one input is active");
    ...
    protected void updateOutputs() {
        setOutputState(this.output,
                (this.input1.isHigh() && this.input2.isHigh())
                || (this.input1.isLow() && this.input2.isLow()),
