...
public abstract class PortController extends Controller {
    ...
    PortController(PortView view) {
        ...
        this.view.getConnectionNodeCircle().onMouseClickedProperty().setValue(e -> this.onClick());

        this.viewModel.onConnectionStateChanged().addListener(this::handleUpdatedConnectionState);
    }
